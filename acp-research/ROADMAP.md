...
> 最后更新：2026-09-16（周扫轮：ANP 复活恢复追踪；新观察项：A2A #2125 Agent Steering → 候选 Extension `urn:acp:ext:steering/v1`；IBM ACP 确认停更 13 个月，降级处理）
...
| **ANP** (社区) | 1,240 | 🟡 复活 | 去中心化身份 | ✅ DID 认证落地中（2026-09 `anp-02` 合入 main） | 恢复追踪，对标 DID 互操作 |
...
| v2.78.0 | POST /trust/signals/capability-token/revoke + GET /revocations — active SINT token revocation; Check 6 in validate; SINT quad complete | 2026-04-07 | `06330bd` |
